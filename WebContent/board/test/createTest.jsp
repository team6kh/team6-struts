...
<body>
	...
	<s:if test="resultClass == NULL">
		<form action="createTestAction.action" method="post"
			enctype="multipart/form-data" onsubmit="return validation();">
	</s:if>

	<s:else>
		<form action="updateTestAction.action" method="post"
		...
		<tr>
			<td align="right" colspan="2">
				...
				<input name="list" type="button" value="목록" class="inputb"
				 onClick="javascript:location.href='listTestAction.action?currentPage=<s:property value="currentPage" />'"></td>
		</tr>
