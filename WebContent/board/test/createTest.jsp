...
<head>
  ...
  <body>
  	<table width="600" border="0" cellspacing="0" cellpadding="2">
  		<tr>
  			<td align="center"><h2>테스트 게시판</h2></td>
  		</tr>
  	</table>
  
		<s:if test="resultClass == NULL">
			<form action="createTestAction.action" method="post" enctype="multipart/form-data" onsubmit="return validation();">
		</s:if>
		
		<s:else>
		  <form action="updateTestAction.action" method="post" enctype="multipart/form-data">
       ...
       <table width="600" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td align="right" colspan="2">
            ...
            <input name="list" type="button" value="목록" class="inputb" onClick="javascript:location.href='listTestAction.action?currentPage=<s:property value="currentPage" />'">
          </td>
        </tr>
